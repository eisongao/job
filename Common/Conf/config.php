...
return array(
	...
	/* 邮箱设置 */
	"MAIL_HOST"       => "smtp.163.com",     //设置126邮箱服务
	"MAIL_SMTPAUTH"   => true,               //设置需要验证
	"MAIL_USERNAME"   => "guchengwuyue@163.com", //发件人使用邮箱
	"MAIL_PASSWORD"   => "hupeng8638004",          //设置发件人密码
	"MAIL_FROM"       => "guchengwuyue@163.com", // 发件人邮箱
